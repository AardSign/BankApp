...
public class Menu {
	...
	/*
	 * Colocaria mais validacoes (Nome da pessoa, cpf...)
	 * colocaria todas as validacoes para dentro das suas classes, ex de deposito negativo, se um dia tu precisar chamar criar depositor em outro
	 * local, tu precisaria validar novamente
	 * 
	 * faria a parte de serializar arraylist de objetos para ter um "banco de dados" no projeto e continuar de onde parou
	 * 
	 * tentaria melhorar a usabilidade do sistema com joptionpane..
	 * 
	 */
